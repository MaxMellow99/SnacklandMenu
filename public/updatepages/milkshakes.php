...
$hoi = selectmanager::selectMilkshakes();

if (isset($_GET["id"])) {
    $hallo = selectmanager::selectidMilkshakes($_GET["id"]);
}
    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            foreach ($hoi as $h) {
                ...
                echo "<td>$h->name</td>";
                echo "<td>$h->price</td>";
                echo "<td><a class=' btn btn-primary' href='updateMilkshakes.php?id=$h->id'>...</a></td>";
                echo "</tr>";
            }
